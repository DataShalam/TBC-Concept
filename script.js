let offersInitSlider, awardsInitSlider;

const initSliders = () => {
  // Remove existing event listeners if they exist
  if (offersInitSlider)
    offersList.removeEventListener("scroll", offersInitSlider);
  if (awardsInitSlider)
    awardsList.removeEventListener("scroll", awardsInitSlider);
  ...
  const offersScrollBarThumb = document.querySelector(
    ".offers-scrollbar-thumb"
  );
  ...
  const awardsScrollBarThumb = document.querySelector(
